...
class InactivityMaxWithWindow(TransformerMixin):
    def __init__(self):
        self.column_names = ['inactivity_max_len']
    ...
    def append_features(self, X):
        ...
        for index, row in X.iterrows():
            ...
            actions_in_the_window_counters.append(max(X_temp['inactivity_len']))

        X['inactivity_max_len'] = actions_in_the_window_counters
        return X
