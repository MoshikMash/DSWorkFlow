...
class ActionCounterWithWindow(TransformerMixin):
    ...
    def append_features(self, X):
        ...
        window_size = configuration_data['time_window_sizes']['action_features']
        ...
        X['action_counter'] = actions_in_the_window_counters
        return X
