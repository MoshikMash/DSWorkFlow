...
class CountersGroupsOneHot(TransformerMixin):
    def __init__(self):
    ...
    def fit(self, X):
        ...
        self.enc.fit(X[self.counter_groups_columns])
        return self

    def transform(self, X):
        return self.enc.transform(X[self.counter_groups_columns])

    def get_feature_names(self):
        return self.enc.get_feature_names(self.counter_groups_columns)
